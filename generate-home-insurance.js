...
const states = [
  { abbr: 'CA', name: 'California', slug: 'california', avgPremium: 1680, avgHome: 790000, minCoverage: 'Dwelling + Liability', naturalDisasters: 'Wildfires, earthquakes (separate policy)', deductible: 1500 },
  { abbr: 'TX', name: 'Texas', slug: 'texas', avgPremium: 3340, avgHome: 310000, minCoverage: 'Dwelling + Liability', naturalDisasters: 'Hurricanes, tornadoes, hail', deductible: 2500 },
  { abbr: 'FL', name: 'Florida', slug: 'florida', avgPremium: 4230, avgHome: 410000, minCoverage: 'Dwelling + Wind', naturalDisasters: 'Hurricanes, flooding (separate policy)', deductible: 3000 },
  { abbr: 'NY', name: 'New York', slug: 'new-york', avgPremium: 1740, avgHome: 440000, minCoverage: 'Dwelling + Liability', naturalDisasters: 'Winter storms, flooding', deductible: 1500 },
  { abbr: 'PA', name: 'Pennsylvania', slug: 'pennsylvania', avgPremium: 1360, avgHome: 270000, minCoverage: 'Dwelling + Liability', naturalDisasters: 'Winter storms, flooding', deductible: 1000 },
  { abbr: 'IL', name: 'Illinois', slug: 'illinois', avgPremium: 1820, avgHome: 260000, minCoverage: 'Dwelling + Liability', naturalDisasters: 'Tornadoes, winter storms', deductible: 1500 },
  { abbr: 'OH', name: 'Ohio', slug: 'ohio', avgPremium: 1290, avgHome: 210000, minCoverage: 'Dwelling + Liability', naturalDisasters: 'Tornadoes, winter storms', deductible: 1000 },
  { abbr: 'GA', name: 'Georgia', slug: 'georgia', avgPremium: 2150, avgHome: 320000, minCoverage: 'Dwelling + Liability', naturalDisasters: 'Hurricanes, tornadoes', deductible: 2000 },
  { abbr: 'CO', name: 'Colorado', slug: 'colorado', avgPremium: 2890, avgHome: 540000, minCoverage: 'Dwelling + Liability', naturalDisasters: 'Hail, wildfires, winter storms', deductible: 2000 },
  { abbr: 'OK', name: 'Oklahoma', slug: 'oklahoma', avgPremium: 3920, avgHome: 195000, minCoverage: 'Dwelling + Liability', naturalDisasters: 'Tornadoes, hail, wind', deductible: 2500 },
];
...
<head>
    ...
    <meta name="description" content="Calculate homeowners insurance costs in ${s.name}. Free ${s.abbr} home insurance calculator with coverage options, discounts, and average rates.">
    <meta name="keywords" content="${s.name} homeowners insurance, ${s.abbr} home insurance calculator, ${s.name} home insurance cost, cheap home insurance ${s.abbr}, ${s.slug} homeowners insurance rates">
...
<body>
    <div class="container">
        ...
        <p>Calculate homeowners insurance costs in ${s.name} (${s.abbr}). Get estimated premiums based on home value, coverage level, location, and property details.</p>
        ...
        <div class="calc-card">
            ...
            <p>A standard policy covers dwelling damage, personal property loss, liability claims, and additional living expenses. It does NOT typically cover floods, earthquakes, or normal wear and tear. ${s.naturalDisasters.includes('flood') || s.naturalDisasters.includes('Hurricane') ? 'Given ' + s.name + "'s flood risk, consider separate flood insurance through NFIP." : ''}</p>
    ...
    function calculate() {
        ...
        // Base rate as percentage of home value
        let baseRate = ${(s.avgPremium / s.avgHome * 100).toFixed(4)} / 100; // state-specific rate
...
// Generate index page for home insurance directory
const indexHtml = `<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Homeowners Insurance Calculator by State 2026 - Compare Home Insurance Rates</title>
    <meta name="description" content="Compare homeowners insurance costs by state. Free calculators for all 50 states with average premiums, coverage options, and money-saving tips.">
    <meta name="keywords" content="homeowners insurance calculator, home insurance by state, home insurance cost, cheap homeowners insurance, compare home insurance rates">
    ...
    <style>
      * { margin:0; padding:0; box-sizing:border-box; }
      body { font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; background: #f5f7fa; color: #2c3e50; line-height: 1.6; }
      .container { max-width: 900px; margin: 2rem auto; padding: 0 2rem; }
      h1 { font-size: 2rem; margin-bottom: 1rem; color: #1a237e; }
      h2 { color: #283593; margin: 1.5rem 0 0.75rem; }
      p { margin-bottom: 1rem; }
      ...
      .state-card h3 { color: #1a237e; margin-bottom: 0.5rem; }
      .state-card .premium { font-size: 1.5rem; font-weight: bold; color: #e74c3c; }
      .state-card .details { color: #7f8c8d; font-size: 0.9rem; margin-top: 0.5rem; }
      .state-card a { display: inline-block; margin-top: 1rem; color: #1a237e; font-weight: 600; text-decoration: none; }
...
<body>
    <div class="container">
        <h1>🏠 Homeowners Insurance Calculator by State</h1>
        <p>Compare homeowners insurance costs across states. Select your state to calculate personalized home insurance estimates based on property value, coverage level, and risk factors.</p>
...
${states.sort((a, b) => a.name.localeCompare(b.name)).map(s => `            <div class="state-card">
                <h3>🏠 ${s.name}</h3>
                <div class="premium">$${s.avgPremium.toLocaleString()}/year</div>
                <div class="details">Avg. home value: $${s.avgHome.toLocaleString()} | Monthly: $${Math.round(s.avgPremium/12)}</div>
        ...
        <div class="nav-links">
            ...
            <a href="/healthcalcs/">← All Calculators</a>
            <a href="/healthcalcs/auto/">Auto Insurance by State</a>
            <a href="/healthcalcs/state/">Health Insurance by State</a>
            <a href="/healthcalcs/life-insurance-calculator.html">Life Insurance</a>
        </div>
...
console.log('Generated: home/index.html');
console.log(`Total files: ${states.length + 1}`);
